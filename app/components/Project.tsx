...
const Project = () => {
  return (
    <motion.div id='project' className='w-full px-[12%] py-15 scroll-mt-20 items-center' initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 1}}>
        ...
        <motion.h2 className='text-center text-5xl font-syne font-medium text-dark-purple' initial={{y: -20, opacity: 0}} whileInView={{y: 0, opacity: 1}} transition={{duration: 0.5, delay: 0.3}}>
            Latest Projects
        </motion.h2>
