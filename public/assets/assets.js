...
export const workData = [
    ...
    {
        title: 'Picverse',
        description: 'Picverse Community is a dynamic online platform designed to empower digital artists through sharing, connection, and recognition. The website features five primary pages, initially prototyped in Figma and then developed using HTML, CSS, and JavaScript, ensuring a responsive, smooth and engaging user experience across various devices.', // eslint-disable-line @typescript-eslint/no-unused-vars
        bgImage: '/work-3.png',
