...
import thalafish from "./thalafish.png";
import planaway from "./planaway.png";
...
export const experienceData = [
  {
    icon: assets.binus,
    title: "Author & Presenter at ICOBAR-SMART 2026",
...
export const projectData = [
  {
    ...
    description:
      "AidBuddy is a vital mobile app developed using Swift, designed to provide immediate and reliable first aid information in emergency situations. Whether dealing with a minor injury or a critical medical emergency, AidBuddy offers step-by-step guidance to help users respond quickly and effectively before professional assistance arrives.",
  ...
  },
  {
    ...
    description:
      "TapeSync is a mobile app built with Flutter that serves as a digital video tape store, allowing customers to browse and purchase tapes, while admins manage tape data. Developed with a Node.js back-end and MySQL database, the app supports CRUD operations, secure JWT-based authentication, and features a responsive UI for a smooth user experience.",
  ...
  },
  {
    ...
    description:
      "Picverse Community is a dynamic online platform designed to empower digital artists through sharing, connection, and recognition. The website features five primary pages, initially prototyped in Figma and then developed using HTML, CSS, and JavaScript, ensuring a responsive, smooth and engaging user experience across various devices.",
  ...
  {
    title: "ThalaFish",
    details: ["Group Project", "Application", "2026"],
    description:
      "ThalaFish is an iOS-based marketplace application developed to facilitate the buying and selling of fish through a seamless and user-friendly mobile experience. The application supports two user roles: Admin and Buyer. The application was developed using Swift (iOS) with Core Data as the local database for efficient on-device data management.",
    bgImage: assets.thalafish,
    icons: [assets.swift],
    link: "",
  },
  {
    ...
    details: ["Group Project", "Application", "2026"],
    description:
      "PlanAway is a Travel Bucket List application built using Swift designed to help users explore, save, and organize their dream travel destinations in a practical and structured way. This project was developed using Swift and SwiftUI for the iOS frontend, with Firebase as the backend for authentication and data management.",
    bgImage: assets.planaway,
    icons: [assets.swift, assets.firebase],
    link: "https://github.com/olynsn15/PlanAway",
  },
];
